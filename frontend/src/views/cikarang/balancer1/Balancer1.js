    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Balancer1 are built with as little markup and styles as possible but still manage to
              deliver a bunch of control and customization. Built with flexbox, they offer easy
              alignment and mix well with other CoreUI components. Balancer1 have no top, left, and
            ...
            <p className="text-body-secondary small">
              Below is an example of a basic card with mixed content and a fixed width. Balancer1
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Balancer1 assume no specific <code>width</code> to start, so they&#39;ll be 100% wide
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Balancer1 include various options for customizing their backgrounds, borders, and
              color.
            </p>
